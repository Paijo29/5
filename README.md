  ...
  <body bgcolor='black' style='margin:0' oncontextmenu='return false' onkeydown='return false'
    ...
    <script>
      async function init() {
        ...
        player.configure({
          drm: {
            clearKeys: {
              ...
              '04c5eaf62cd75f2d947ab4d621f39256': '76967598962e7a7314a2b251e9070725'
            }
          }
        });
        ...
        try {
          await player.load('https://director.streaming.telia.com/tvm-packager-prod/group1/6089c17d47a23d76645ceaf4/manifest.mpd');
